...
"""Verify that starting infaqcoin with -h works as expected."""
import subprocess

from test_framework.test_framework import infaqcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(infaqcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start infaqcoin with -? for help text")
        ...
        self.log.info("Start infaqcoin with -version for version information")
