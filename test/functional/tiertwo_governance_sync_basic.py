...
from test_framework.test_framework import infaqcoinTier2TestFramework
...
class MasternodeGovernanceBasicTest(infaqcoinTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.infaqcoin.org/t/test-proposal"
