...
class ListReceivedTest (infaqcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 IQC.
        ...
        # Send 1 IQC to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 IQC sending them all (fee is 0.1 IQC)
        ...
        # Confirm transaction (2 IQC from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 IQC, send 0.6 IQC + 0.05 IQC fee
