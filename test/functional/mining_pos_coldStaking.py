...
from test_framework.infaqcoin_node import infaqcoinTestNode
...
class INFAQCOIN_ColdStakingTest(infaqcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(infaqcoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 IQC from the pot)
...
if __name__ == '__main__':
    INFAQCOIN_ColdStakingTest().main()
