...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/infaqcoin-cli.cpp \
           src/infaqcoin-tx.cpp \
           src/infaqcoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/infaqcoin.qrc src/qt/infaqcoin_locale.qrc

TRANSLATIONS += src/qt/locale/infaqcoin_bg.ts \
                src/qt/locale/infaqcoin_de.ts \
                src/qt/locale/infaqcoin_en.ts \
                src/qt/locale/infaqcoin_es.ts \
                src/qt/locale/infaqcoin_fi.ts \
                src/qt/locale/infaqcoin_fr.ts \
                src/qt/locale/infaqcoin_it.ts \
                src/qt/locale/infaqcoin_ja.ts \
                src/qt/locale/infaqcoin_pl.ts \
                src/qt/locale/infaqcoin_pt.ts \
                src/qt/locale/infaqcoin_ru.ts \
                src/qt/locale/infaqcoin_sk.ts \
                src/qt/locale/infaqcoin_sv.ts \
                src/qt/locale/infaqcoin_vi.ts \
                src/qt/locale/infaqcoin_zh_CN.ts \
                src/qt/locale/infaqcoin_zh_TW.ts
