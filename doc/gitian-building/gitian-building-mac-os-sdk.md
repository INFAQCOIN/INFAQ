...
The script [extract-osx-sdk.sh](https://github.com/infaqcoin-project/infaqcoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
infaqcoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/infaqcoin-project/infaqcoin/blob/master/doc/README_osx.md) for troubleshooting tips.
