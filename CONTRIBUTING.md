Contributing to INFAQCOIN
============================

The INFAQCOIN project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/infaqcoin-project/infaqcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the INFAQCOIN project, and is not to be
confused with overall INFAQCOIN Network Protocol consensus changes.

Whether a pull request is merged into INFAQCOIN rests with the project merge
...
Patches that change INFAQCOIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the INFAQCOIN consensus, it must have been
...
The project leader is the release manager for each INFAQCOIN release.
