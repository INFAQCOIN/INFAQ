...
public:
    ...
    /**
     * Amount of infaqcoin coming in to a transaction
...
// INFAQCOIN: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
