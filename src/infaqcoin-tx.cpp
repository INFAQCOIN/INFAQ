...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = _("infaqcoin infaqcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  infaqcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded infaqcoin transaction") + "\n" +
                               "  infaqcoin-tx [options] -create [commands]   " + _("Create hex-encoded infaqcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded infaqcoin transaction
