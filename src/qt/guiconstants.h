...
/* infaqcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "INFAQCOIN"
#define QAPP_ORG_DOMAIN "infaqcoin.org"
#define QAPP_APP_NAME_DEFAULT "INFAQCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "INFAQCOIN-Qt-testnet"
