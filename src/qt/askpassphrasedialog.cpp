...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            INFAQCOINGUI* window = static_cast<INFAQCOINGUI*>(parentWidget());
...
{
    INFAQCOINGUI* gui = static_cast<INFAQCOINGUI*>(parentWidget());
...
{
    hide();
    static_cast<INFAQCOINGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("INFAQCOIN will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your IQCs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
