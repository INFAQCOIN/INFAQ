...
/** Utility functions used by the INFAQCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render INFAQCOIN addresses in monospace font
...
// Parse "infaqcoin:" URI into recipient object, return true on successful parsing
