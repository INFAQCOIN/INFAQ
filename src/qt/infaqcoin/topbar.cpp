...
#include "qt/infaqcoin/topbar.h"
#include "qt/infaqcoin/forms/ui_topbar.h"
#include "qt/infaqcoin/lockunlock.h"
#include "qt/infaqcoin/qtutils.h"
#include "qt/infaqcoin/receivedialog.h"
#include "qt/infaqcoin/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/infaqcoin/balancebubble.h"
...
TopBar::TopBar(INFAQCOINGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopIqc, ui->labelAmountTopShieldedIqc}, "amount-small-topbar");
    setCssProperty({ui->labelAmountIqc}, "amount-topbar");
    setCssProperty({ui->labelPendingIqc, ui->labelImmatureIqc}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("INFAQCOIN")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // IQC Total
    QString totalIqc = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // IQC
    // Top
    ui->labelAmountTopIqc->setText(totalTransparent);
    ui->labelAmountTopShieldedIqc->setText(totalShielded);
    // Expanded
    ui->labelAmountIqc->setText(totalIqc);
    ui->labelPendingIqc->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureIqc->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
