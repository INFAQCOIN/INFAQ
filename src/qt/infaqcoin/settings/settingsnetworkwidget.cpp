...
#include "qt/infaqcoin/settings/settingsnetworkwidget.h"
#include "qt/infaqcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/infaqcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(INFAQCOINGUI* _window, QWidget *parent) :
