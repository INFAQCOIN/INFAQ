...
#include "qt/infaqcoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>

SettingsExportCSV::SettingsExportCSV(INFAQCOINGUI* _window, QWidget* parent) : PWidget(_window, parent),
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
        ...
        isTxExport ? tr("INFAQCOIN_tx_csv_export(*.csv)") : tr("INFAQCOIN_addresses_csv_export(*.csv)"),
        nullptr);
