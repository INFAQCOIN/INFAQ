...
#include "qt/infaqcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(INFAQCOINGUI* _window, QWidget *parent) :
