...
#include "qt/infaqcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/infaqcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(INFAQCOINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to INFAQCOINGUI::handleRestart()
