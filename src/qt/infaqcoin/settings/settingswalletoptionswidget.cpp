...
#include "qt/infaqcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/infaqcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(INFAQCOINGUI* _window, QWidget *parent) :
