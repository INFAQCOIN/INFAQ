...
#include "qt/infaqcoin/furabstractlistitemdelegate.h"
#include "qt/infaqcoin/txviewholder.h"
#include "qt/infaqcoin/tooltipmenu.h"
#include "qt/infaqcoin/sendmultirow.h"
#include "qt/infaqcoin/coldstakingmodel.h"
#include "qt/infaqcoin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(INFAQCOINGUI* parent);
    ~ColdStakingWidget();
