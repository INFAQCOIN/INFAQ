...
#include "qt/infaqcoin/sendcustomfeedialog.h"
#include "qt/infaqcoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(INFAQCOINGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &INFAQCOINGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
