...
#ifndef INFAQCOIN_CORE_NEW_GUI_INFAQCOINGUI_H
#define INFAQCOIN_CORE_NEW_GUI_INFAQCOINGUI_H
...
#include "qt/infaqcoin/navmenuwidget.h"
#include "qt/infaqcoin/topbar.h"
#include "qt/infaqcoin/dashboardwidget.h"
#include "qt/infaqcoin/send.h"
#include "qt/infaqcoin/receivewidget.h"
#include "qt/infaqcoin/addresseswidget.h"
#include "qt/infaqcoin/coldstakingwidget.h"
#include "qt/infaqcoin/masternodeswidget.h"
#include "qt/infaqcoin/snackbar.h"
#include "qt/infaqcoin/settings/settingswidget.h"
...
/**
  INFAQCOIN GUI main class. This class represents the main window of the INFAQCOIN UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class INFAQCOINGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit INFAQCOINGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~INFAQCOINGUI();
...
#endif //INFAQCOIN_CORE_NEW_GUI_INFAQCOINGUI_H
