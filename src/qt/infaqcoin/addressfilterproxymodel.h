...
#ifndef INFAQCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define INFAQCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //INFAQCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
