...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, INFAQCOINGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, INFAQCOINGUI* gui, double posX = 3);
