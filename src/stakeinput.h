...
#ifndef INFAQCOIN_STAKEINPUT_H
#define INFAQCOIN_STAKEINPUT_H
...
class CIqcStake : public CStakeInput
{
private:
...
public:
    CIqcStake(const CTxOut& _from, const COutPoint& _outPointFrom, const CBlockIndex* _pindexFrom) :
            CStakeInput(_pindexFrom), outputFrom(_from), outpointFrom(_outPointFrom) {}

    static CIqcStake* NewIqcStake(const CTxIn& txin);
