...
extern const char * const INFAQCOIN_CONF_FILENAME;
extern const char * const INFAQCOIN_PID_FILENAME;
extern const char * const INFAQCOIN_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("infaqcoin-%s", name);
